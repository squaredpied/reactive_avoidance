...
if __name__ == "__main__":
    ...
    # Reactive RMP
    launch_file = join(base_path, '..', 'rmp_barn_challenge/launch/reactive_RMP.launch')
    nav_stack_process = subprocess.Popen([
        'roslaunch',
        launch_file,
        'gui:=' + ("true" if args.gui else "false")
    ...
    goal_pub = rospy.Publisher("/goal", Point, queue_size=1)
    goal_point = Point()
    ...
    # Reactive RMP with VFH
    # launch_file = join(base_path, '..', 'rmp_barn_challenge/launch/reactive_wVFH_RMP.launch')
    # nav_stack_process = subprocess.Popen([
    #     'roslaunch',
    #     launch_file,
    #     'gui:=' + ("true" if args.gui else "false")
    ...
    # goal_pub1 = rospy.Publisher("/goal_point", PointStamped, queue_size=1)
    # goal_point1 = PointStamped()
    # goal_point1.header.frame_id = "odom"
    # goal_point1.point.x = GOAL_POSITION[0]
    # goal_point1.point.y = GOAL_POSITION[1]
    # goal_point1.point.z = 0
    # time.sleep(5)
    # goal_pub1.publish(goal_point1)
